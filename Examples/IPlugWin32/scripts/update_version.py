...
def main():
  ...
  plistpath = scriptpath + "/resources/IPlugWin32-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugWin32-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugWin32-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugWin32-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugWin32-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/IPlugWin32.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/IPlugWin32.iss",inplace=1):
