...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=IPlugWin32 Demo Installer\n"
      else:
        line="OutputBaseFilename=IPlugWin32 Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the IPlugWin32 Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the IPlugWin32 installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=IPlugWin32 Demo installer\n"
     else:
       line="SetupWindowTitle=IPlugWin32 installer\n"
